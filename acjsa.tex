...
is based on giving the user a Virtual Machine that is then customized to
...
the Gould Belt Legacy Survey \citep{2007PASP..119..855W}.  In its use of CANFAR, the GBS data
