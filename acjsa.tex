...
the UK Starlink project, which had recently been closed. {\color{red} The
...
The commitment to a JCMT Science Aarchive was followed shortly
...
extend its holdings with a small amount of effort, CADC developed CAOM
\citep[the Common Archive Observation
  Model;][]{2007ASPC..376..347D,2008ASPC..394..426D}, an extensive and
...
clump (extended non-uniform emission) catalogues. CADC was planning
the next version of their data model, CAOM, and realized that JCMT
provided an excellent stretch to their model; if JCMT data could be
