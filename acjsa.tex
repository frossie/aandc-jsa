...
\title{Observatory/data center partnerships and the VO-centric archive:
...
{\color{red} We present, as a case study, a description of the
  partnership between an observatory (JCMT) and a data center (CADC)
  that led to the development of the JCMT Science Archive (JSA). The
  JSA is an successful example of a service designed with VO-centric
  technologies from the start. We descrive the motivation, process and
...
{\color{red}
If this section does not have any additional content the content could
be moved into the current status section pretty easily.
}
