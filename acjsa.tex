...
\caption{Single bolometer time-series from a subset of a SCUBA-2
  pointing observation of G34.3. The final image is shown in
...
{\color{red}
We should cite the other CADC A\&C VO paper \citep{2014ACCADC}
somewhere here and if possible that paper should cite this one. Is
that paper really going to be in the September issue?
}
